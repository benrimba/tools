...
echo
echo $pur"==================="$cy" ==================="
echo $i"=="$pu"  AUTHOR  :  Rudi Hartono  "$i"           "
echo $i"=="$pu"  WhatsApp:  085777919166"$i"             "
echo $i"=="$pu"  GMAIL   :  rudiedukasi@gmail.com"$i"    "
echo $i"=="$pu"  YOUTUBE :  YouTube Rudi Edukasi"$i"     "
echo $pur"==================="$cy" ==================="
echo
...
sleep 2
echo $ku"Facebook :"$i" Rudi Hartono"
echo $ku"YouTube  :"$i" YouTube Rudi Edukasi"
echo $ku"WhatsApp :"$i" 085777919166"
sleep 2
